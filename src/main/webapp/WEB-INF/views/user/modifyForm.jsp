...
<body>
	<div id="wrap">
		...
		<div id="content">
			...
			<div id="user">
				<div id="modifyForm">
					<form action="/mysite/user/userUpdate" method="get">
					<input type="hidden" name="no" value="${user.no}">
					<input type="hidden" name="id" value="${user.id}">
						<!-- 아이디 -->
						<div class="form-group">
							<label class="form-text" for="input-uid">아이디</label> <span
								class="text-large bold">${user.id}</span>
						</div>

						<!-- 비밀번호 -->
						<div class="form-group">
							<label class="form-text" for="input-pass">패스워드</label>
							<input type="password" id="input-pass" name="password" value="${model.password}"
						...
						<div class="form-group">
							<label class="form-text" for="input-name">이름</label> <input
								type="text" id="input-name" name="name" value="${model.name}"
